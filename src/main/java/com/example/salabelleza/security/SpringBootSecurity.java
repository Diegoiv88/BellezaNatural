package com.example.salabelleza.security;
...
//            "/buscar", // Buscador de productos
        ...
        http.csrf().disable()
                ...
                .antMatchers("/admin/**", "/productos/**", "/servicios/**", "/usuario/**").hasRole("ADMIN") // Rutas protegidas - solo pueden acceder quienes tengan el rol "ADMIN"
